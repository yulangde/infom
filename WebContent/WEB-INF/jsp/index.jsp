...
<div id="main">
    ...
    <div class="content">
    	<div class="congw">
             <div class="clear"></div>
            <div class="box">
            <c:forEach items="${categorylist}" var="c" varStatus="state">
            	<div class="box_b">
                	<div class="title">
                    	<span class="txt_title">${c.name }</span>
                        <span class="txt_discipline">作者</span>
                        <span class="txt_time">
                        	<a class="txt_time" href="list.html?id=${c.code}&&name=${c.name}"> 更多>> </a>
                        </span>
                    </div>
                    <div class="cont">
                    	<ul class="discipUI">
					...
					<c:forEach items="${c.articles }" var="a" >                    	
                        	<li>
                            	<a href="content.html?id=${a.id }&&name=${c.name }" class="txt_title">
                            		${a.title }
                            	</a>
