	...
	<div class="main">
		<div id="top">
			<div class="top">
				...
				<div class="t_sign">
					<span>你好，<font color="red">${AdminLogin}</font>管理员</span><a href="logout.action" class="t_exit">退出</a>
				</div>
			</div>
		</div>
		<div id="cont">
			<div class="centent">
				<div class="left">
					<ul class="baseUI">
					<!-- 地址 -->
						<li url="articleList.html">
							<a href="javascript:void(0);">
								<em class="base_basicset"></em>
								<span>信息管理</span>
							</a>
						</li>
						<li url="articlePublisur.html">
							<a href="javascript:void(0);">
								<em class="base_roll">
								</em><span>信息发布</span>
							</a>
						</li>
						<li url="categoryList.html">
							<a href="javascript:void(0);">
								<em class="base_userset"></em>
								<span>栏目管理</span>
							</a>
						</li>
						<li url="addCategory.html">
							<a href="javascript:void(0);">
								<em class="base_auth">
								</em><span>添加栏目</span>
							</a>
